...
(use-package emacs
    ...
    (custom-file (concat user-emacs-directory "customs.el"))
...
(use-package consult
    ...
    (dobin/leader-keys
        ...
        "sr" '("[r]ipgrep" . consult-ripgrep)
        "sG" '("[G]it grep" . consult-git-grep)
        "sf" '("[f]ind" . consult-find)
        "sF" '("locate" . consult-locate)
        "sl" '("[l]ine" . consult-line)
        "i" '("[i]menu" . consult-imenu)
        )
